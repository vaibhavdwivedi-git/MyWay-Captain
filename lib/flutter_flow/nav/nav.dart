...
class AppStateNotifier extends ChangeNotifier {
  MyWayCaptainFirebaseUser? initialUser;
  MyWayCaptainFirebaseUser? user;
  ...
  void update(MyWayCaptainFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Signup3',
              path: 'signup3',
              builder: (context, params) => Signup3Widget(
                name: params.getParam('name', ParamType.String),
            ...
            FFRoute(
              name: 'ThankyouScreen',
              path: 'thankyouScreen',
              builder: (context, params) => ThankyouScreenWidget(),
            ),
            FFRoute(
              name: 'SettingPage',
              path: 'settingPage',
